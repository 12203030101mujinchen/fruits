...
def test_cnn():
    # 加载数据
    train_ds, test_ds, class_names = data_load("C:/Users/mujinchen/Desktop/fruits/fruit_split/train",
                                              "C:/Users/mujinchen/Desktop/fruits/fruit_split/val", 224, 224, 16)
    # 加载模型
    model = tf.keras.models.load_model("models/cnn_fruits.h5")
    # model.summary()
    # 测试
