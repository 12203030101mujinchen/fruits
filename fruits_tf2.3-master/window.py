...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        # 模型初始化
        self.model = tf.keras.models.load_model("models/cnn_fruits.h5")
        self.to_predict_name = "images/caomei.jpg"
        self.class_names = ['佛手瓜', '哈密瓜', '木瓜', '李子', '枇杷', '柠檬', '桂圆', '梨', '榴莲', '橘子', '毛丹', '牛油果', '猕猴桃', '甘蔗', '番石榴-百', '白兰瓜', '白心火龙果', '百香果', '粑粑柑', '红心火龙果', '红苹果', '胡萝卜', '芒果', '芦柑', '草莓', '荔枝', '莲雾', '菠萝', '菠萝莓', '菠萝蜜', '葡萄-白', '蓝莓', '蟠桃', '车厘子', '金桔', '黄桃', '黑莓']
